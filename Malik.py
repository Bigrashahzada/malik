...
#            total = open(" hasil/%s"%(file)).read().splitlines()
            ...
            jeeck(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Tidak ada RIAZ :V")
            raw_input('\n%s [ %senter %s] '%(P,B,P));menu()
...
def masuk():
    ...
    jeeck("\033[0;36m[\033[0;35m5\033[0;36m]\033[0;00m preliminary ]\033[0;33m[ \033[0;35mPEND RIAZ-KHAN \033[0;33m]")
...
def cek_opsi():
    print(" \033[0;33mMasukan file Contoh : \033[0;00mRIAZ/CP-22-Januari-2222.txt")
